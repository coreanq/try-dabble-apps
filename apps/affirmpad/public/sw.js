...
// affirmations, topics and prefs live in localStorage, not in the HTTP cache,
// so the pad works offline from the second visit on. Nothing here talks to
// any third party.
const CACHE = "affirmpad-v1";
const ASSETS = [
  "/",
  "/index.html",
