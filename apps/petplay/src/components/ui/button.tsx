...
/**
 * Pills for the pet card: coral primary, card-white secondary, mint for the
 * backup side, a muted coral for destructive. The shadcn API is untouched —
 * only the dress. Form buttons on the cards are .pp-btn because they sit in
 * two-column grids.
 */
  ...
  "group/button inline-flex shrink-0 items-center justify-center gap-1.5 rounded-full border font-bold whitespace-nowrap transition-transform duration-75 outline-none select-none touch-manipulation focus-visible:ring-3 focus-visible:ring-ring/40 active:translate-y-[1px] disabled:pointer-events-none disabled:opacity-40 aria-invalid:border-destructive [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-coral/40 bg-coral-soft text-coral-ink shadow-[0_2px_0_rgba(232,93,76,0.25)] hover:brightness-95",
        link: "border-transparent text-coral-deep underline-offset-4 shadow-none hover:underline active:translate-y-0",
      },
      size: {
