...
const BASE = process.env.PLAYCUE_URL || "http://127.0.0.1:8788";
...
const CASES = [
  {
    ...
    ogLocale: "en_US",
    ogImage: "https://playcue.try-dabble.com/og-image-en.png",
  },
  {
    lang: "ja",
    htmlLang: "ja",
    ...
    ogLocale: "ja_JP",
    ogImage: "https://playcue.try-dabble.com/og-image-ja.png",
  },
  {
    lang: "zh",
    htmlLang: "zh",
    ...
    ogLocale: "zh_CN",
    ogImage: "https://playcue.try-dabble.com/og-image-zh.png",
  },
  {
    lang: "ko",
    htmlLang: "ko",
    ...
    ogLocale: "ko_KR",
    ogImage: "https://playcue.try-dabble.com/og-image-ko.png",
  },
];
...
test("the feedback widget is appended with data-app=playcue", async () => {
  const res = await fetch(`${BASE}/`);
  const html = await res.text();
  assert.match(html, /widget\/feedback\.js" data-app="playcue" defer/);
});
