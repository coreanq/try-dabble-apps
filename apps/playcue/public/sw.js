// Network-first for the shell so a deploy shows up on the next open; the audio
// itself is never cached here — it lives in OPFS, not in the HTTP cache.
const CACHE = "playcue-v1";
const ASSETS = [
  "/",
  "/index.html",
