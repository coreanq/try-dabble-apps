...
// workouts, meals, weigh-ins, foods, routines and prefs live in localStorage, not in the HTTP cache,
// so the tracker works offline from the second visit on. Nothing here talks to
// any third party.
const CACHE = "gymac-v1";
const ASSETS = [
  "/",
  "/index.html",
