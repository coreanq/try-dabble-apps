...
test("no login, paywall, IAP or subscription pitch anywhere in the app copy", () => {
  ...
  assert.doesNotMatch(text, /sign in|log in|premium|unlock (pro|premium)|start (your )?free trial/i);
});
