...
// rates snapshot and the traveler's prefs live in localStorage, not in the
// HTTP cache, so the converter works offline as soon as one sync succeeded.
// Frankfurter is cross-origin and is deliberately left alone here.
const CACHE = "fxpad-v1";
const ASSETS = [
  "/",
  "/index.html",
