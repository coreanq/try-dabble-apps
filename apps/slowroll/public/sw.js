...
// frames themselves are never cached here — they live in IndexedDB on this
// device, not in the HTTP cache, and never touch the network at all.
const CACHE = "slowroll-v1";
const ASSETS = [
  "/",
  "/index.html",
