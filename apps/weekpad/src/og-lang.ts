...
> = {
  ko: {
    ...
    locale: 'ko_KR',
    image: 'https://weekpad.try-dabble.com/og-image-ko.png',
  ...
  en: {
    ...
    locale: 'en_US',
    image: 'https://weekpad.try-dabble.com/og-image-en.png',
  ...
  ja: {
    ...
    locale: 'ja_JP',
    image: 'https://weekpad.try-dabble.com/og-image-ja.png',
  ...
  zh: {
    ...
    locale: 'zh_CN',
    image: 'https://weekpad.try-dabble.com/og-image-zh.png',
...
const SLUG = 'weekpad';
const ORIGIN = 'https://weekpad.try-dabble.com';
 ...
 * say "Weekpad", so the Worker rewrites name / lang / start_url per request.
  ...
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (lang) {
      ...
      html = new HTMLRewriter()
        ...
        .on('.wp-tagline', { element(el) { el.setInnerContent(copy.tagline); } })
        .on('meta', {
          element(el) {
