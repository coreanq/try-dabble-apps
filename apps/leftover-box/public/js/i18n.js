window.LB_I18N = {
  en: {
    ...
    metaDescription: "Log leftover dishes and eat-by dates. Eat the oldest first. Data stays on this device.",
    about: "FridgeBuddy, eggg, and pecco are inventory + login + AI recipe apps. This is just leftover names and eat-by dates. No account — everything stays in this browser.",
    langLabel: "Language",
  ...
  ko: {
    ...
    shortName: "반찬함",
    tagline: "오래된 반찬부터 먹기",
    metaDescription: "남은 반찬 이름과 먹을 날짜만 적습니다. 오래된 것부터 먹습니다. 데이터는 이 기기에만 남습니다.",
    about: "FridgeBuddy·eggg·pecco는 재고·로그인·AI 레시피 앱입니다. 반찬함은 남은 음식 이름과 먹을 날짜만 적습니다. 계정 없이 이 브라우저에만 저장됩니다.",
    langLabel: "언어",
    addTitle: "반찬 넣기",
    labelName: "반찬 이름",
    namePh: "어제 찌개",
  ...
  ja: {
    ...
    shortName: "残りもの",
    tagline: "古い残りものから食べる",
    metaDescription: "残りものの名前と食べる期限だけ残します。古いものから食べます。データはこの端末だけです。",
    about: "FridgeBuddy・eggg・peccoは在庫・ログイン・AIレシピアプリです。これは残りものの名前と期限だけ。アカウントなし、このブラウザだけです。",
    langLabel: "言語",
    addTitle: "残りものを入れる",
    labelName: "料理名",
    namePh: "昨日の鍋",
    ...
    exportJson: "JSON書き出し",
    importJson: "JSON読み込み",
    toolsHint: "端末を移すときはJSONを持っていってください。サーバーには上がりません。",
    privacy: "プライバシー",
    terms: "利用規約",
    edit: "編集",
    eaten: "食べた",
  ...
  zh: {
    ...
    about: "FridgeBuddy、eggg、pecco 是库存+登录+AI食谱应用。这里只记剩菜名字和食用日期。无需账户，只存在此浏览器。",
    langLabel: "语言",
    addTitle: "添加剩菜",
    labelName: "菜名",
    namePh: "昨天的汤",
