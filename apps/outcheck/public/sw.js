// Network-first for the shell so a deploy shows up on the next open. The list
// and today's checks live in localStorage, not in the HTTP cache.
const CACHE = "outcheck-v1";
const ASSETS = [
  "/",
  "/index.html",
